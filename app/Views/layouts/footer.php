    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p class="text-white">
                    <a href="<?= base_url('/') ?>" class="text-white">Home</a><br>
                    <a href="<?= base_url('/#Trip') ?>" class="text-white">Trip</a><br>
                    <a href="<?= base_url('gallery') ?>" class="text-white">Gallery</a><br>
                    <a href="<?= base_url('about') ?>" class="text-white">About</a><br>
            </div>
        ...
        <div class="text-center text-white">
            <p class="text-white mb-0 pb-3">© <?= date('Y') ?> BLNTRK OUTDOOR</p>
        </div>
    </div>
</footer>