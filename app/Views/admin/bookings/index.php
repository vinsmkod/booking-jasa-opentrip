...
<div class="page-header" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:16px;">
    ...
    <div class="page-header-right">
        <form action="" method="get" style="display:flex; gap:8px;">
            <input type="text" name="search" value="<?= esc($search ?? '') ?>" placeholder="Cari Kode atau Nama..." style="padding:8px 12px; border:1px solid var(--border); border-radius:6px; font-size:13px; outline:none; min-width:250px;">
            ...
            <?php if (!empty($search)): ?>
                <a href="<?= base_url('admin/bookings') ?>" style="padding:8px 16px; background:var(--surface2); color:var(--txt); border:1px solid var(--border); border-radius:6px; text-decoration:none; display:flex; align-items:center; font-size:13px;"><i class="fas fa-times"></i></a>
            <?php endif; ?>
        </form>
    </div>
</div>
