...
.tbl td {
    ...
    padding: 12px 14px; border-bottom: 1px solid rgba(0,0,0,.05); vertical-align: top;
}
.tbl tbody tr:hover td { background: #fafafa; }
.tbl tbody tr:last-child td { border-bottom: none; }

.td-no    { font-family: var(--mono); font-size: 11.5px; color: var(--txt3); width: 40px; }
.td-name  { font-weight: 500; color: var(--txt); line-height: 1.3; }
...
.btn-approve:hover { background: #dcfce7; text-decoration: none; color: #15803d; }
.btn-reject  { background: #fffbeb; color: #b45309; border-color: #fde68a; }
.btn-reject:hover  { background: #fef9c3; text-decoration: none; color: #b45309; }
...
<div class="layout">
    ...
    <header class="topbar">
        ...
        <div class="topbar-breadcrumb">
            ...
            <span class="crumb-active">komentar</span>
        </div>
    ...
    <div class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                ?>
                <?php if ($pending > 0): ?>
                <span style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;background:#fef9c3;color:#a16207;border:1px solid #fde68a;padding:6px 14px;border-radius:20px;">
                    <i class="fas fa-clock"></i> <?= $pending ?> komentar menunggu review
                </span>
                <?php endif; ?>
            </div>
            ...
            <div class="panel">
                <div class="panel-header">
                    <span class="panel-title">
                        <i class="fas fa-comments"></i> Daftar Komentar
                    </span>
                    <span style="font-size:12px;color:var(--txt3);font-family:var(--mono);">
                        <?= count($comments ?? []) ?> total komentar
                    </span>
                </div>
                            ...
                            <?php if (!empty($comments)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-row">
                                            <?php if ($s === 'pending'): ?>
                                                <a href="/admin/comments/approve/<?= $c['comment_id'] ?>" class="btn-sm btn-approve">
                                                    <i class="fas fa-check"></i> Approve
                                                </a>
                                                <a href="/admin/comments/reject/<?= $c['comment_id'] ?>" class="btn-sm btn-reject">
